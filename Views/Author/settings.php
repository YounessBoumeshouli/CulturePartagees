...
?>
  ...
  <span class="mx-2 h-6 w-6 text-primary-500">
    <svg class="h-full w-full" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 20h9M3 20h6M9 12l3 3 3-3M12 6l3 3-3 3-3-3 3-3z" />
    </svg>
  </span>
  <span class="mx-2 w-72 truncate text-gray-700" id="bioDisplay">Lorem ipsum dolor sit amet...</span>
  <textarea id="bioInput" class="mx-2 w-72 hidden rounded border px-2" rows="4">Lorem ipsum dolor sit amet...</textarea>
  <button onclick="toggleEditForm('bio')" class="absolute right-0 bg-white p-1 rounded-full shadow-lg hover:bg-gray-100">
    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
    </svg>
  </button>
