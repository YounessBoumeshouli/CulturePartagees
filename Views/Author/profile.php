        ...
        <div class="px-6">
            ...
            <div class="w-full lg:w-4/12 px-4 lg:order-1">
              <div class="flex justify-center py-4 lg:pt-4 pt-8">
                ...
                <div class="mr-4 p-3 text-center">
                  <span class="text-xl font-bold block uppercase tracking-wide text-blueGray-600"><?=$result["articles"]?></span><span class="text-sm text-blueGray-400">Articles</span>
                </div>
                <div class="lg:mr-4 p-3 text-center">
                  <span class="text-xl font-bold block uppercase tracking-wide text-blueGray-600"><?=$result["comments"]?></span><span class="text-sm text-blueGray-400">Comments</span>
                </div>
              </div>
            </div>
            <?php
          ...
          <div class="text-center mt-12">
            ...
            <div class="mb-2 text-blueGray-600 mt-10">
              <i class="fas fa-briefcase mr-2 text-lg text-blueGray-400"></i><?=$result['phone']?>
            </div>
            <div class="mb-2 text-blueGray-600">
              <i class="fas fa-university mr-2 text-lg text-blueGray-400"></i><?=$result['registrationdate']?>
            </div>
          </div>
