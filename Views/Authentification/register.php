...
<div class="flex items-center justify-center flex-col text-center min-h-screen">
  <div class="flex flex-col items-center justify-center bg-[#EDDCD9] border-2 border-[#264143] rounded-lg shadow-[3px_4px_0px_1px_#E99F4C] p-8">
    <p class="font-extrabold text-xl mb-5">SIGN UP</p>
    <form class="w-full max-w-xs" method = "post" action="index.php?action=SignUp">
      <div class="flex flex-col items-start mb-4">
        <label class="font-semibold mb-1" for="name">Name</label>
        <input placeholder="Enter your full name" class="border-2 border-[#264143] shadow-[3px_4px_0px_1px_#E99F4C] w-full p-3 rounded text-sm focus:outline-none focus:translate-y-1 focus:shadow-[1px_2px_0px_0px_#E99F4C]" type="text" name="name">
      </div>
      <div class="flex flex-col items-start mb-4">
        <label class="font-semibold mb-1" for="prenom">Name</label>
        <input placeholder="Enter your full name" class="border-2 border-[#264143] shadow-[3px_4px_0px_1px_#E99F4C] w-full p-3 rounded text-sm focus:outline-none focus:translate-y-1 focus:shadow-[1px_2px_0px_0px_#E99F4C]" type="text" name="prenom">
      </div>
      <div class="flex flex-col items-start mb-4">
        <label class="font-semibold mb-1" for="name">Author ?</label>
      ...
      <div class="flex flex-col items-start mb-4">
        ...
        <input placeholder="Enter your email" name="email" class="border-2 border-[#264143] shadow-[3px_4px_0px_1px_#E99F4C] w-full p-3 rounded text-sm focus:outline-none focus:translate-y-1 focus:shadow-[1px_2px_0px_0px_#E99F4C]" type="email">
      </div>
      <div class="flex flex-col items-start mb-4">
        <label class="font-semibold mb-1" for="phone">Phone</label>
        <input placeholder="Enter your phone number" name="phone" class="border-2 border-[#264143] shadow-[3px_4px_0px_1px_#E99F4C] w-full p-3 rounded text-sm focus:outline-none focus:translate-y-1 focus:shadow-[1px_2px_0px_0px_#E99F4C]" type="text">
      </div>
      <div class="flex flex-col items-start mb-4">
        <label class="font-semibold mb-1" for="password">Password</label>
        <input placeholder="Enter your password" name="password" class="border-2 border-[#264143] shadow-[3px_4px_0px_1px_#E99F4C] w-full p-3 rounded text-sm focus:outline-none focus:translate-y-1 focus:shadow-[1px_2px_0px_0px_#E99F4C]" type="password">
      </div>
      <button type="submit" class="bg-[#DE5499] w-full p-4 text-sm font-extrabold text-black rounded shadow-[3px_3px_0px_0px_#E99F4C] hover:opacity-90 focus:translate-y-1 focus:shadow-[1px_2px_0px_0px_#E99F4C]">SIGN UP</button>
      <p class="mt-4 font-semibold text-sm">Have an Account? <a href="#" class="text-[#264143] font-extrabold hover:underline">Login Here!</a></p>
    </form>
  </div>
</div>
<?php
