...
ob_start();
?>
<div class="bg-gray-900  w-screen flex items-center justify-center flex-wrap">
...
foreach($result as $Comment ){
  ...
  ?>
<div
  class="[--shadow:rgba(60,64,67,0.3)_0_1px_2px_0,rgba(60,64,67,0.15)_0_2px_6px_2px] w-4/5 h-auto rounded-2xl bg-white [box-shadow:var(--shadow)] max-w-[300px] ml-9 mb-9"
>
  <div
