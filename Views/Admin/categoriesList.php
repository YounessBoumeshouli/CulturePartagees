...
<div class="bg-gray-900 h-screen w-screen flex items-center justify-center flex-wrap">
  ...
  ?>
    <article
        class="w-64 transition-all m-6 ease-in-out duration-150 border-4 border-transparent rounded-lg p-2 cursor-pointer bg-white hover:shadow-[10px_10px_0_#4e84ff,20px_20px_0_#4444bd] hover:-translate-x-5 hover:-translate-y-5 hover:border-[#0578c5] active:shadow-none active:translate-x-0 active:translate-y-0">
        <div class="rounded-lg bg-gray-400 h-44 w-full"></div>
        <div class="flex flex-col gap-5 p-2 pt-5">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-semibold text-black truncate m-0"><?=$row['label']?></h2>
                <div
                    class="w-12 h-12 rounded-full p-2 transition-transform ease-in-out duration-300 bg-white hover:bg-[#a6c2f0] hover:-rotate-45">
                    <svg xmlns="http://www.w3.org/2000/svg" class="text-black" width="32" height="32" fill="none"
            ...
            <div class="flex gap-2">
                <span
                    class="px-3 py-1 text-xs font-bold rounded-full bg-[rgba(165,96,247,0.43)] text-[rgb(85,27,177)]">•
                    Delete</span>
                <span class="px-3 py-1 text-xs font-bold rounded-full bg-[#b2b2fd] text-[#1a41cd]">• UPDATE</span>
            </div>
        </div>
    </article>
