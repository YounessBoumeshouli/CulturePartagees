...
<body class="font-body antialiased">
  <div class="flex items-center overflow-x-auto whitespace-nowrap py-4 ml-8">
    ...
    <a href="index.php?action=ArticlesList" class="-px-2 flex items-center text-gray-600 hover:underline dark:text-gray-200">
    ...
    <a href="index.php?action=categoriesList" class="-px-2 flex items-center text-gray-600 hover:underline dark:text-gray-200">
      <span class="w-24px h-24px mx-2 h-6 w-6">
        <svg
          class="w-[inherit] h-[inherit]"
          xmlns="http://www.w3.org/2000/svg"
